...
![pic]({{ site.url }}/assets/images/os-1.png)

接着是，按下“Ctrl+C”，进入调试状态，可以看见下图中的结果。

![pic]({{ site.url }}/assets/images/os-2.png)
...
![pic]({{ site.url }}/assets/images/os-5.png)
